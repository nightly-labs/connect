...
export type ServerToClient = { type: "GetInfoResponse" } & GetInfoResponse | { type: "ConnectResponse" } & ConnectResponse | { type: "SignTransactionsEvent" } & SignTransactionsEvent | { type: "SignMessagesEvent" } & SignMessagesEvent | { type: "AppDisconnectedEvent" } & AppDisconnectedEvent | { type: "GetPendingRequestsResponse" } & GetPendingRequestsResponse | { type: "ErrorMessage" } & ErrorMessage | { type: "AckMessage" } & AckMessage;