...
This process is initialized by one side displaying a sessionId through QR code (check the screenshot).
...
const adapter = await NightlyConnectIotaAdapter.build(
  {
    appMetadata: {
      name: 'NCTestIOTA',
