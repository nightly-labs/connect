...
export type AppToServer = { type: "InitializeRequest" } & InitializeRequest | { type: "SignTransactionsRequest" } & SignTransactionsRequest | { type: "SignMessagesRequest" } & SignMessagesRequest;