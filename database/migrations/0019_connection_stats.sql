...
---------------------------------------------------------------- CONNECTION STATS(WALLET NAME) BASED ON EVENT ----------------------------------------------------------------
...
---------------------------------------------------------------- CONNECTION STATS(SESSION TYPE) BASED ON EVENT ----------------------------------------------------------------
------------------- 15-minutes events stats per app -----------------
--- View
...
--- Real time aggregation
ALTER MATERIALIZED VIEW quarter_events_client_connect_session_type_stats_per_app
SET (timescaledb.materialized_only = false);
...
--- Real time aggregation
ALTER MATERIALIZED VIEW hour_events_client_connect_session_type_stats_per_app
SET (timescaledb.materialized_only = false);
...
--- Real time aggregation
ALTER MATERIALIZED VIEW daily_events_client_connect_session_type_stats_per_app
SET (timescaledb.materialized_only = false);