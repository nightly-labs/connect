...
pub async fn create_folder(
    ...
    create_folder_command: models::CreateFolderCommand,
) -> Result<models::Folder, Error<CreateFolderError>> {
...
pub async fn delete_folder(
    configuration: &configuration::Configuration,
    folder_uid: &str,
    force_delete_rules: Option<bool>,
) -> Result<models::DeleteFolder200Response, Error<DeleteFolderError>> {
    let local_var_configuration = configuration;
    ...
    let local_var_uri_str = format!(
        ...
        folder_uid = crate::apis::urlencode(folder_uid)
    );
    let mut local_var_req_builder =
    ...
    if let Some(ref local_var_str) = force_delete_rules {
        local_var_req_builder =
            local_var_req_builder.query(&[("forceDeleteRules", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_user_agent) = local_var_configuration.user_agent {
        local_var_req_builder =
            local_var_req_builder.header(reqwest::header::USER_AGENT, local_var_user_agent.clone());
...
pub async fn get_folder_by_id(
    configuration: &configuration::Configuration,
    folder_id: i64,
) -> Result<models::Folder, Error<GetFolderByIdError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetFolderByIdError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn get_folder_by_uid(
    configuration: &configuration::Configuration,
    folder_uid: &str,
) -> Result<models::Folder, Error<GetFolderByUidError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetFolderByUidError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn get_folder_descendant_counts(
    configuration: &configuration::Configuration,
    folder_uid: &str,
) -> Result<std::collections::HashMap<String, i64>, Error<GetFolderDescendantCountsError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetFolderDescendantCountsError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn get_folders(
...
) -> Result<Vec<models::FolderSearchHit>, Error<GetFoldersError>> {
    let local_var_configuration = configuration;
    ...
    if let Some(ref local_var_str) = parent_uid {
        local_var_req_builder =
            local_var_req_builder.query(&[("parentUid", &local_var_str.to_string())]);
    }
...
pub async fn move_folder(
    configuration: &configuration::Configuration,
    folder_uid: &str,
    move_folder_command: models::MoveFolderCommand,
) -> Result<models::Folder, Error<MoveFolderError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<MoveFolderError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn update_folder(
    configuration: &configuration::Configuration,
    folder_uid: &str,
    update_folder_command: models::UpdateFolderCommand,
) -> Result<models::Folder, Error<UpdateFolderError>> {
    let local_var_configuration = configuration;
