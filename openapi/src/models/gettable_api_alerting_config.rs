...
pub struct GettableApiAlertingConfig {
    ...
    #[serde(rename = "muteTimeProvenances", skip_serializing_if = "Option::is_none")]
    pub mute_time_provenances: Option<std::collections::HashMap<String, String>>,
    ...
    pub receivers: Option<Vec<models::GettableApiReceiver>>,
...
impl GettableApiAlertingConfig {
    pub fn new() -> GettableApiAlertingConfig {
        GettableApiAlertingConfig {
            global: None,
            inhibit_rules: None,
            mute_time_provenances: None,
