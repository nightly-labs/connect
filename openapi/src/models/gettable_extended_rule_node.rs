...
pub struct GettableExtendedRuleNode {
    ...
    pub grafana_alert: Option<Box<models::GettableGrafanaRule>>,
...
impl GettableExtendedRuleNode {
    pub fn new() -> GettableExtendedRuleNode {
